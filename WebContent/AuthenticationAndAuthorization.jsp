...
<div class="container">
  ...
  <ul class="breadcrumb">
   <li ><a href="questions.jsp">Operating System</a></li>
    ...
    <li class="active">Authentication And Authorization</li>
...
<form action="Infrastructure.jsp">
...
<h3 class="container-fluid">Authentication and Authorization</h3>
<table>
...
while(iterator8.hasNext()){
   ...
   <td>
	<label for="<%=autEntry.getKey() %>"> Q<%=i%> : <%=autEntry.getValue() %> </td></label><td>
	<input type="text" value="" name="<%=autEntry.getKey() %>" required size="150" placeholder="Enter an answer" style=" width: 400px; height: 100px; margin-left: 100px; margin-top: 3px;">
	<br /><br /></td></div>
