...
i=1;
%>
<h3 class="container-fluid">Data Center</h3>
<table>
...
while(iterator2.hasNext()){
   ...
   <div class="form-group">
    <td>
	<label for="<%=dcEntry.getKey() %>" style=" width: 400px; height: 100px; margin-left: 130px; margin-top: 3px;"> Q<%=i%> : <%=dcEntry.getValue() %> </td></label><td>
	<input type="text" value="" name="<%=dcEntry.getKey() %>" required size="150" placeholder="Enter an answer" style=" width: 400px; height: 100px; margin-left: 100px; margin-top: 3px;">
	<br /><br /></td></div>
