...
<form action="ApplicationDevelopment.jsp">
...
<h3 class="container-fluid">Agility</h3>
<table>
...
while(iterator4.hasNext()){
   ...
   <td>
	...
	<label for="<%=agEntry.getKey() %>style=" width: 400px; height: 100px; margin-left: 130px; margin-top: 3px;""> Q<%=i%> : <%=agEntry.getValue() %> </td></label><td>
	<input type="text" value="" name="<%=agEntry.getKey() %>" required size="150" placeholder="Enter an answer" style=" width: 400px; height: 100px; margin-left: 100px; margin-top: 3px;">
	<br /><br /></td></div>
