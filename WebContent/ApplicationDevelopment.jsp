...
<div class="container">
  ...
  <ul class="breadcrumb">
    ...
    <li class="active">Application And Development</li>  
...
<form action="AuthenticationAndAuthorization.jsp">
...
i=1;
%>
<h3 class="container-fluid">Application Development</h3>
<table>
...
while(iterator5.hasNext()){
   ...
   <td>
	<label for="<%=appEntry.getKey() %>" style=" width: 400px; height: 100px; margin-left: 130px; margin-top: 3px;"> Q<%=i%> : <%=appEntry.getValue() %> </td></label><td>
	<input type="text" value="" name="<%=appEntry.getKey() %>" required size="150" placeholder="Enter an answer" style=" width: 400px; height: 100px; margin-left: 100px; margin-top: 3px;">
	<br /><br /></td></div>
